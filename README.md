...
* [语义化版本](http://semver.org/lang/zh-CN/)
  ...
  > 版本号范围标记
  >
  > 版本号范围的标记符号有很多种, 诸如比较符号 >=、< 等; 连接符 -; 通配符 x、*; 模糊符 ^、~. 具体的用法可参考 [NPM 官方文档](https://docs.npmjs.com/misc/semver)
  >
  > 建议在写法上采用"通配符的写法"跟进每个小版本更新, 即书写为 1.x 表达的版本号范围 >=1.0.0 <2.0.0
