...
最后我想说的是: 前端工程师最大的瓶颈就是**不会后端**. 感觉好像很矛盾啊, 但其实不是, 最重要的是认识到应该适时地跳出自己的圈子, 看看外面的世界. 事实上前端工程师或者说所有的工程师, 通过项目和经验的历练, 最终都渴望突破成为全栈(前/后端)和全端(PC端/移动端)工程师, 因为我们都希望可以独立地完成一件"作品".
